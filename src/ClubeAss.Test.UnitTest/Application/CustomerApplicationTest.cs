namespace ClubeAss.Test.UnitTest.Application
{
    ...
    //        var result = new CustomerApplication(CustomerRepositoryMoq.Object, imapperMoq.Object)
    ...
    //        var result = new CustomerApplication(CustomerRepositoryMoq.Object, imapperMoq.Object).GetByid(new CustomerGetRequest(guid)).Result;
    ...
    //        var result = new CustomerApplication(CustomerRepositoryMoq.Object, imapperMoq.Object).GetAll().Result;
    ...
    //        var result = new CustomerApplication(CustomerRepositoryMoq.Object, imapperMoq.Object).Remove(new CustomerDeleteRequest(guid)).Result;
